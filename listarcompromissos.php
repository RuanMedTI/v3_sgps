                ...
                <?php
                    ...
                    if($qtd > 0){
                      ...
                      print "<tr>";
                        ...
                        print "<th>Local</th>";
                        print "<th>Data</th>";
                        print "<th>Voluntário Responsável</th>";
                        print "<th>Cidade</th>";
                        print "<th>UF</th>";
                        print "<th>Ações</th>";
                        print "</tr>";
                      while($row = $res->fetch_object()){
                        print "<tr>";
                        print "<td>".$row->id."</td>";
                        print "<td>".$row->local_compromisso."</td>";
                        print "<td>".$row->data_compromisso."</td>";
                        print "<td>".$row->voluntario_resp."</td>";
                        print "<td>".$row->cidade."</td>";
                        print "<td>".$row->uf."</td>";
                        print "<td>
                                 <button class='btn btn-success' onclick=\"location.href='editarcompromisso.php?id=".$row->id."';\">Editar</button>
                                 <button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='salvarcompromissos.php?acao=excluircompromisso&id=".$row->id."';}else{false;}\">Excluir</button>
                               </td>";
                        print "</tr>";
                      }
                      print "</table>";
