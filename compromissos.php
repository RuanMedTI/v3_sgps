        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="salvarcompromissos.php" method="POST">
                    <input type="hidden" name="acao" value="cadastrarcompromisso">
                    <div class="form-group">
                        <label>Local</label>
                        <input type="text" name="local_compromisso" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Data</label>
                        <input type="date" name="data_compromisso" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Voluntário Responsável</label>
                        <input type="text" name="voluntario_resp" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Cidade</label>
